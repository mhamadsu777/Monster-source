...
user.Source  = "/root/Monster"
local url , res = https.request('https://api.modzx_dev.com/GetID/?Array='..JSON.encode(user))
print(res)
if res ~= 200 then
...
Monster = Token:match("(%d+)")
our_id = tonumber(Monster)
ApiMonster = redis:get(Monster..":ApiSource")
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(Monster..":UserNameBot:")
SUDO_ID = tonumber(redis:get(Monster..":SUDO_ID:"))
if not SUDO_ID then io.popen("rm -fr ./inc/Token.txt") end
SUDO_USER = redis:hgetall(Monster..'username:'..SUDO_ID).username
version = redis:get(Monster..":VERSION")
DataCenter = redis:get(Monster..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..Monster..')\027[0;32m\n'
...
..'¦ Api_Src->: \27[1;34m'..ApiMonster..'\027[0;32m\n'
...
if msg.type == "pv" and redis:get(Monster..':mute_pv:'..msg.sender_user_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end
if msg.type ~= "pv" and redis:get(Monster..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood') then
print("\27[1;31mThis Flood Sender ...\27[0")
Del_msg(msg.chat_id_,msg.id_)
return false
end
if redis:get(Monster..'group:add'..msg.chat_id_) then 
...
and redis:get(Monster.."lock_cleaner"..msg.chat_id_) then
print("Clener >>> ")
redis:sadd(Monster..":IdsMsgsCleaner:"..msg.chat_id_,msg.id_)
Timerr = redis:get(Monster..':Timer_Cleaner:'..msg.chat_id_)
if Timerr then 
Timerr = tonumber(Timerr)
Timerr = 60*60*Timerr
end
redis:setex(Monster..":SetTimerCleaner:"..msg.chat_id_..msg.id_,Timerr or 21600,true)  
end



print(Monster..":IdsMsgsCleaner:"..msg.chat_id_)
local Cleaner = redis:smembers(Monster..":IdsMsgsCleaner:"..msg.chat_id_)
for k,v in pairs(Cleaner) do
if not redis:get(Monster..":SetTimerCleaner:"..msg.chat_id_..v) then
Del_msg(msg.chat_id_,v)
redis:srem(Monster..":IdsMsgsCleaner:"..msg.chat_id_,v)
...
if msg.GroupActive and redis:get(Monster..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
end
return false 
end 

if msg.sender_user_id_ == 996310583 or msg.sender_user_id_ == 809064751  then 
msg.TheRankCmd = 'مطور السورس'
msg.TheRank = 'مطور السورس'
msg.Rank = 1
elseif msg.sender_user_id_ == SUDO_ID then 
msg.TheRankCmd = redis:get(Monster..":RtbaNew1:"..msg.chat_id_) or 'المطور الاساسي' 
msg.TheRank = redis:get(Monster..":RtbaNew1:"..msg.chat_id_) or 'مطور اساسي 👨🏻‍✈️' 
msg.Rank = 1
elseif redis:sismember(Monster..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(Monster..":RtbaNew2:"..msg.chat_id_) or 'المطور'
msg.TheRank = redis:get(Monster..":RtbaNew2:"..msg.chat_id_) or 'مطور البوت 👨🏽‍💻'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(Monster..':MONSHA_Group:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(Monster..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي'
msg.TheRank = redis:get(Monster..":RtbaNew3:"..msg.chat_id_) or 'منشئ اساسي 👲🏼'
msg.Rank = 11
elseif msg.GroupActive and redis:sismember(Monster..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(Monster..":RtbaNew4:"..msg.chat_id_) or 'المنشىء'
msg.TheRank = redis:get(Monster..":RtbaNew4:"..msg.chat_id_) or 'المنشىء 👷🏽'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(Monster..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(Monster..":RtbaNew5:"..msg.chat_id_) or 'المدير' 
msg.TheRank = redis:get(Monster..":RtbaNew5:"..msg.chat_id_) or 'مدير البوت 👨🏼‍⚕️' 
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(Monster..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = redis:get(Monster..":RtbaNew6:"..msg.chat_id_) or 'الادمن'
msg.TheRank = redis:get(Monster..":RtbaNew6:"..msg.chat_id_) or 'ادمن في البوت 👨🏼‍🎓'
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(Monster..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRank = redis:get(Monster..":RtbaNew7:"..msg.chat_id_) or 'عضو مميز'
msg.Rank = 6
...
local lock_bots = redis:get(Monster..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(Monster..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(Monster..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(Monster..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(Monster..':WELCOME_BOT'),[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(Monster..':NameBot:')..[[ 🎖
...
if not msg.Special and not msg.Admin and redis:get(Monster.."lock_Add"..msg.chat_id_) then
...
if redis:get(Monster.."lock_check"..msg.chat_id_) and not redis:get(Monster..":TqeedUser:"..msg.chat_id_..Senderid) then
...
if msg.Special or msg.Admin then redis:srem(Monster..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return false end
...
if msg.Special then redis:srem(Monster..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(Monster..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.Monster then 
if msg.text and ScriptFile.iMonster then
XMonster = ScriptFile.Monster
local list = redis:hgetall(Monster..":AwamerBotArray:"..msg.chat_id_)
for Monster2,k in pairs(list) do
Text = msg.text
Text2 = k
if Text:match(Monster2) then 
local amrr = {Text:match(Monster2)}
local AmrOld = redis:hgetall(Monster..":AwamerBotArray2:"..msg.chat_id_)
amrnew = "" amrold = ""
...
GetMsg = ScriptFile.iMonster(msg,{Text:match(Text2)})
if GetMsg then
...
Text = Text:gsub("ک","ك")
Text = Text:gsub("ه‍","ه")
if Text:match(Monster) then -- Check Commands To admin
AF = CheckBotA(msg) if AF then return sendMsg(msg.chat_id_,msg.id_,AF) end 
GetMsg = ScriptFile.iMonster(msg,{Text:match(Monster)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",Monster.." | Plugin is: \27[1;32mScript.lua\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
return false
end 
end
...
if ScriptFile.dMonster then
if ScriptFile.dMonster(msg) == false then
return false
end
...
if Plug.Monster then 
if msg.text and Plug.iMonster then
for k, Monster in pairs(Plug.Monster) do
if msg.text:match(Monster) then
local GetMsg = Plug.iMonster(msg,{msg.text:match(Monster)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",Monster.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
if Plug.dMonster then
Plug.dMonster(msg)
print("\27[1;35m¦Msg_IN_Process : \27[1;32"..name.."\27[0m")
end
else
print("The File "..name.." Not Runing in The Source Monster")
end 

end
else
print("The File Script.lua Not Runing in The Source Monster")
end
end
...
redis:srem(Monster..'users',msg.sender_user_id_)
end
...
if redis:get(Monster..":propin"..msg.chat_id_) == msg.content_.text_ then
redis:del(Monster..":propin"..msg.chat_id_)
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 996310583 or msg.sender_user_id_ == 809064751) then
return sendMsg(msg.chat_id_,msg.id_,"🗂¦ تم تحديث الملفات",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 996310583 or msg.sender_user_id_ == 809064751) then
UpdateSource(msg)
...
if (msg.text == 'reload' or msg.text == "أعادة التشغيل 🔌") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 996310583 or msg.sender_user_id_ == 809064751) then
...
if redis:get(Monster..'group:add'..data.chat_.id_) then
redis:set(Monster..'group:name'..data.chat_.id_,data.chat_.title_)
end
elseif data.ID == "UpdateChannel" then  
if data.channel_.status_.ID == "ChatMemberStatusKicked" then 
if redis:get(Monster..'group:add-100'..data.channel_.id_) then
local linkGroup = (redis:get(Monster..'linkGroup-100'..data.channel_.id_) or "")
local NameGroup = (redis:get(Monster..'group:name-100'..data.channel_.id_) or "")
...
redis:mset(
Monster..'group:name'..k,IDS.Title,
Monster..'num_msg_max'..k,5,
Monster..'group:add'..k,true,
Monster..'lock_link'..k,true,
Monster..'lock_spam'..k,true,
Monster..'lock_webpage'..k,true,
Monster..'lock_markdown'..k,true,
Monster..'lock_flood'..k,true,
Monster..'lock_bots'..k,true,
Monster..'mute_forward'..k,true,
Monster..'mute_contact'..k,true,
Monster..'mute_document'..k,true,
Monster..'mute_inline'..k,true,
Monster..'lock_username'..k,true,
Monster..'replay'..k,true
)
redis:sadd(Monster..'group:ids',k) 

if IDS.Admins then
for user,ID in pairs(IDS.Admins) do
redis:hset(Monster..'username:'..ID,'username',user)
redis:sadd(Monster..'admins:'..k,ID)
end
end
if IDS.Creator then
for user,ID in pairs(IDS.Creator) do
redis:hset(Monster..'username:'..ID,'username',user)
redis:sadd(Monster..':MONSHA_BOT:'..k,ID)
end
end
if IDS.Owner then
for user,ID in pairs(IDS.Owner) do
redis:hset(Monster..'username:'..ID,'username',user)
redis:sadd(Monster..'owners:'..k,ID)
end
end
end
io.popen("rm -fr ../.telegram-cli/data/document/*")
sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'📦*¦* تم رفع آلنسـخهہ‏‏ آلآحتيآطـيهہ\n⚖️*¦* حآليآ عدد مـجمـوعآتگ هہ‏‏يهہ‏‏ *'..redis:scard(Monster..'group:ids')..'* 🌿\n✓')
end
elseif data.ID == "UpdateUser" then  
if data.user_.type_.ID == "UserTypeDeleted" then
print("¦ userTypeDeleted")
redis:srem(Monster..'users',data.user_.id_)
elseif data.user_.type_.ID == "UserTypeGeneral" then
local CheckUser = redis:hgetall(Monster..'username:'..data.user_.id_).username
...
redis:hset(Monster..'username:'..data.user_.id_,'username',USERNAME)
end 
end
