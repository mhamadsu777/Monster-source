...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(Monster..":NameBot:") or "مونستر"
...
local Fshar_Word , res = https.request('https://api.th3Monster.com/Words_Fshars.txt')
...
Fshar_Word , res = https.request('https://api.th3Monster.com/Words_Fshars.txt')
if res ~= 200 then Fshar_Word = "\n" end
...
var = redis:get(Monster..":RtbaNew1:"..ChatID) or 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(Monster..':SUDO_BOT:',UserID) then
var = redis:get(Monster..":RtbaNew2:"..ChatID) or 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(Monster..':MONSHA_Group:'..ChatID,UserID) then
var = redis:get(Monster..":RtbaNew3:"..ChatID) or ' المنشىء اساسي👷🏽' 
elseif redis:sismember(Monster..':MONSHA_BOT:'..ChatID,UserID) then
var = redis:get(Monster..":RtbaNew4:"..ChatID) or ' المنشىء 👷🏽' 
elseif redis:sismember(Monster..'owners:'..ChatID,UserID) then
var = redis:get(Monster..":RtbaNew5:"..ChatID) or 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(Monster..'admins:'..ChatID,UserID) then
var = redis:get(Monster..":RtbaNew6:"..ChatID) or 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(Monster..'whitelist:'..ChatID,UserID) then
var = redis:get(Monster..":RtbaNew7:"..ChatID) or 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
return var
...
Replay = Replay:gsub("{البوت}",redis:get(Monster..':NameBot:'))
...
if msg.edited then
redis:incr(Monster..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info_ then
redis:incr(Monster..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.content_.ID == "MessageChatAddMembers" then 
redis:incr(Monster..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessagePhoto" then
redis:incr(Monster..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageSticker" then
redis:incr(Monster..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVoice" then
redis:incr(Monster..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAudio" then
redis:incr(Monster..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageVideo" then
redis:incr(Monster..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.content_.ID == "MessageAnimation" then
redis:incr(Monster..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local monshaas = redis:smembers(Monster..':MONSHA_Group:'..msg.chat_id_)
local monsha = redis:smembers(Monster..':MONSHA_BOT:'..msg.chat_id_)
local Owners = redis:smembers(Monster..'owners:'..msg.chat_id_)
local Admins = redis:smembers(Monster..'admins:'..msg.chat_id_)
local mmez = redis:smembers(Monster..'whitelist:'..msg.chat_id_)
...
local list = redis:smembers(Monster..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`★`*_* ['..SUDO_USER..'] ➣ (' ..SUDO_ID.. '){'..redis:scard(Monster..'mtwr_count'..SUDO_ID)..'}\n*----------------------------------*\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info  = redis:hgetall(Monster..'username:'..v)
local count = redis:scard(Monster..'mtwr_count'..v)
if info and info.username and info.username:match("@[%a%d_]+") then
...
local list = redis:smembers(Monster..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(Monster..'admins:'..msg.chat_id_)
...
local list = redis:smembers(Monster..'whitelist:'..msg.chat_id_)
...
if redis:sismember(Monster..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(Monster..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(Monster..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(Monster..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(Monster..'gban_users')
...
local list = redis:smembers(Monster..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(Monster..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*¦* الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(Monster..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(Monster..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(Monster..':Filter_Word:'..msg.chat_id_,word) 
...
local NumberFlood = tonumber(redis:get(Monster..':Flood_Spam:'..User..':'..ChatID..':msgs') or 0)
if NumberFlood >= 5 then 
result = false
else
redis:setex(Monster..':Flood_Spam:'..User..':'..ChatID..':msgs',2,NumberFlood+1)
result = true
end
return result
end
...
json_data = '{"BotID": '..Monster..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(Monster..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(Monster..'group:name'..GroupS) or '')
...
local admins = redis:smembers(Monster..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(Monster..'username:'..value)
if info then 
...
local creator = redis:smembers(Monster..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(Monster..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(Monster..'group:ids')
message = '📋*¦* قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(Monster..'group:name'..v)
if info then 
...
redis:del(
Monster..'group:add'..id_group,
Monster..'lock_link'..id_group, 
Monster..'lock_id'..id_group,
Monster..'lock_spam'..id_group, 
Monster..'lock_webpage'..id_group,
Monster..'lock_markdown'..id_group,
Monster..'lock_flood'..id_group,
Monster..'lock_bots'..id_group,
Monster..'mute_forward'..id_group,
Monster..'mute_contact'..id_group,
Monster..'mute_location'..id_group,
Monster..'mute_document'..id_group,
Monster..'mute_keyboard'..id_group,
Monster..'mute_game'..id_group,
Monster..'mute_inline'..id_group,
Monster..'lock_username'..id_group,
Monster..'num_msg_max'..id_group,
Monster..'mute_text'..id_group,
Monster..'admins:'..id_group,
Monster..':Filter_Word:'..id_group,
Monster..'banned:'..id_group,
Monster..'is_silent_users:'..id_group,
Monster..'whitelist:'..id_group,
Monster..':MONSHA_BOT:'..id_group,
Monster..'owners:'..id_group,
Monster..'replay'..id_group,
Monster..':MONSHA_Group:'..id_group
)
redis:srem(Monster..'group:ids',id_group)
end
...
NumAdmin = NumAdmin + 1
if not redis:sismember(Monster..'admins:'..arg.chat_id_,v.user_id_) then
GetUserID(v.user_id_,function(arg,data)
redis:hset(Monster..'username:'..data.id_,'username',ResolveUserName(data))
redis:sadd(Monster..'admins:'..arg.chat_id_,data.id_)
...
if redis:get(Monster..'group:add'..msg.chat_id_) then  return sendMsg(msg.chat_id_,msg.id_,'📬¦ المجموعه بالتأكيد ✓️ تم تفعيلها \n📮¦ بواسطه ⋙「 '..NameUser..' 」 \n') end
...
local GroupUsers = tonumber(redis:get(Monster..':addnumberusers') or 0)
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(Monster..'username:'..data.id_,'username', ResolveUserName(data))
redis:sadd(Monster..':MONSHA_Group:'..arg.chat_id_,data.id_)
...
redis:mset(
Monster..'group:add'..arg.chat_id_,true,
Monster..'lock_link'..arg.chat_id_,true, 
Monster..'lock_id'..arg.chat_id_,true,
Monster..'lock_spam'..arg.chat_id_,true,
Monster..'lock_webpage'..arg.chat_id_,true,
Monster..'lock_markdown'..arg.chat_id_,true,
Monster..'lock_flood'..arg.chat_id_,true,
Monster..'lock_bots'..arg.chat_id_,true,
Monster..'mute_forward'..arg.chat_id_,true,
Monster..'mute_contact'..arg.chat_id_,true,
Monster..'mute_location'..arg.chat_id_,true,
Monster..'mute_document'..arg.chat_id_,true,
Monster..'mute_keyboard'..arg.chat_id_,true,
Monster..'mute_game'..arg.chat_id_,true,
Monster..'mute_inline'..arg.chat_id_,true,
Monster..'lock_username'..arg.chat_id_,true,
Monster..'num_msg_max'..arg.chat_id_,5, 
Monster..'lock_edit'..arg.chat_id_,true,
Monster..'replay'..arg.chat_id_,true,
Monster..'lock_rdodSource'..arg.chat_id_,true,
Monster.."lock_KickBan"..msg.chat_id_,true,
Monster.."lock_mmno3"..msg.chat_id_,true,
Monster.."lock_KickBan"..msg.chat_id_,true,
Monster.."lock_RandomRdod"..msg.chat_id_,true,
Monster.."lock_linkk"..msg.chat_id_,true
)
redis:sadd(Monster..'group:ids',arg.chat_id_) 
redis:sadd(Monster..'mtwr_count'..arg.sender_user_id_,arg.chat_id_)

local NameGroup = data.title_
redis:set(Monster..'group:name'..arg.chat_id_,NameGroup)
...
redis:set(Monster..'linkGroup'..arg.chat_id_,Gp_Link)
...
redis:hset(Monster..'username:'..UserID, 'username', Resolv)
redis:sadd(Monster..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم تقييده بنجاح \n✓")
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(Monster..':tqeed:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم فك تقييده بنجاح \n✓")
end
if cmd == "setwhitelist" then
if redis:sismember(Monster..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مميز  في المجموعه \n✓") 
end
redis:hset(Monster..'username:'..UserID, 'username', Resolv)
redis:sadd(Monster..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مميز  في المجموعه \n✓") 
end
if cmd == "remwhitelist" then
if not redis:sismember(Monster..'whitelist:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مميز  في المجموعه \n✓") 
end
redis:srem(Monster..'whitelist:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مميز  في المجموعه \n✓") 
end
if cmd == "setmnsha" then
if redis:sismember(Monster..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ  في المجموعه \n✓") 
end
redis:hset(Monster..'username:'..UserID, 'username', Resolv)
redis:sadd(Monster..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ  في المجموعه \n✓") 
end
if cmd == "remmnsha" then
if not redis:sismember(Monster..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ  في المجموعه \n✓") 
end
redis:srem(Monster..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشى  في المجموعه \n✓") 
end

if cmd == "setowner" then
if redis:sismember(Monster..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه مدير  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(Monster..'username:'..UserID, 'username', Resolv)
redis:sadd(Monster..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه مدير  في المجموعه \n✓") 
end
if cmd == "remowner" then
if not redis:sismember(Monster..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مدير  في المجموعه \n✓") 
end
redis:srem(Monster..'owners:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مدير  في المجموعه \n✓") 
end
if cmd == "promote" then
if redis:sismember(Monster..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه ادمن  في المجموعه \n✓") 
end
Resolv = Resolv:gsub([[\_]],"_")
redis:hset(Monster..'username:'..UserID, 'username', Resolv)
redis:sadd(Monster..'admins:'..ChatID,UserID) 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه ادمن  في المجموعه \n✓") 
end
if cmd == "demote" then
if not redis:sismember(Monster..'admins:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله ادمن  في المجموعه \n✓") 
end
redis:srem(Monster..'admins:'..ChatID,UserID)
...
if cmd == "Upmonsh" then
if redis:sismember(Monster..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد رفعه منشئ اساسي  في المجموعه \n✓") 
end
redis:hset(Monster..'username:'..UserID,'username',USERNAME)
redis:sadd(Monster..':MONSHA_Group:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم رفعه منشئ اساسي  في المجموعه \n✓") 
end

if cmd == "Dwmonsh" then
if not redis:sismember(Monster..':MONSHA_Group:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه \n✓") 
end
redis:srem(Monster..':MONSHA_Group:'..ChatID,UserID) 
...
redis:hset(Monster..'username:'..UserID, 'username', Resolv)
redis:sadd(Monster..'banned:'..ChatID,UserID)
...
redis:hset(Monster..'username:'..UserID, 'username', Resolv)
redis:srem(Monster..'banned:'..ChatID,UserID)
StatusLeft(ChatID,UserID)
return false
end
...
redis:hset(Monster..'username:'..UserID, 'username', Resolv)
redis:sadd(Monster..'is_silent_users:'..ChatID,UserID)
...
redis:hset(Monster..'username:'..UserID, 'username', Resolv)
redis:srem(Monster..'is_silent_users:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء كتمه  من المجموعه \n✓") 
end

if cmd == "upMshrf" then
redis:hset(Monster..'username:'..UserID,'username',Resolv)
redis:setex(Monster..":uploadingsomeon:"..ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(Monster..":uploadingsomeon2:"..ChatID..msg.sender_user_id_,500,UserID)
...
if cmd == "tfa3l" then  
local maseegs = redis:get(Monster..'msgs:'..UserID..':'..ChatID) or 1
local edited = redis:get(Monster..':edited:'..ChatID..':'..UserID) or 0
local content = redis:get(Monster..':adduser:'..ChatID..':'..UserID) or 0
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
if UserID == 996310583 or UserID == 809064751 then return sendMsg(ChatID,MsgID,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
...
.."\n📝¦ التعديل » "..(redis:get(Monster..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗¦ الروابط » "..(redis:get(Monster..'lock_link'..msg.chat_id_) or 'false')
.."\n#️⃣¦ التاك » "..(redis:get(Monster..'lock_tag'..msg.chat_id_) or 'false')
.."\n©¦ المعرفات » "..(redis:get(Monster..'lock_username'..msg.chat_id_) or 'false')
.."\n\n💱¦ التكرار » "..(redis:get(Monster..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑¦ الكلايش » "..(redis:get(Monster..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐¦ الويب » "..(redis:get(Monster..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️¦ الماركدوان » "..(redis:get(Monster..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻¦ البوتات بالطرد » "..(redis:get(Monster..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖¦ البوتات » "..(redis:get(Monster..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕¦ عدد التكرار » "..(redis:get(Monster..'num_msg_max'..msg.chat_id_) or 'false')
.."\n⏰¦ وقت التنظيف » "..(redis:get(Monster..':Timer_Cleaner:'..msg.chat_id_) or '6').." ساعة ."
.."\n\n🎬¦` اعدادات الوسائط :`\n"
.."\n🤹*¦* المتحركه » "..(redis:get(Monster..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭¦ الدردشه » "..(redis:get(Monster..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️¦ الانلاين » "..(redis:get(Monster..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮¦ الالعاب » "..(redis:get(Monster..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞¦ الصور » "..(redis:get(Monster..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥¦ الفيديو » "..(redis:get(Monster..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙¦ الصوت » "..(redis:get(Monster..'mute_audio'..msg.chat_id_) or 'false')
.."\n\n🔉¦ البصمات » "..(redis:get(Monster..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎¦ الملصقات » "..(redis:get(Monster..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞¦ الجهات » "..(redis:get(Monster..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱¦ التوجيه » "..(redis:get(Monster..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐¦ الموقع » "..(redis:get(Monster..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂¦ الملفات » "..(redis:get(Monster..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅¦ الاشعارات » "..(redis:get(Monster..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒¦ الفشار » "..(redis:get(Monster..'lock_mmno3'..msg.chat_id_) or 'false')
.."\n🔒¦ الفارسيه » "..(redis:get(Monster..'lock_pharsi'..msg.chat_id_) or 'false')
.."\n🔒¦ الانكليزيه » "..(redis:get(Monster..'lock_lang'..msg.chat_id_) or 'false')
.."\n🔒¦ الاضافه » "..(redis:get(Monster..'lock_Add'..msg.chat_id_) or 'false')

local eueuf = "\n\n*⚒¦*` اعدادات اخرى : `"
.."\n*🙋🏼‍♂️¦* الترحيب » "..(redis:get(Monster..'welcome:get'..msg.chat_id_) or 'false')
.."\n*📋¦*  الردود » "..(redis:get(Monster..'replay'..msg.chat_id_) or 'false')
.."\n*📋¦*  الردود العشوائيه » "..(redis:get(Monster.."lock_RandomRdod"..msg.chat_id_) or 'false')
.."\n*🚸¦*  التحذير » "..(redis:get(Monster..'lock_woring'..msg.chat_id_) or 'false')
.."\n*📝¦* الايدي » "..(redis:get(Monster..'lock_id'..msg.chat_id_) or 'false')
.."\n*💬¦* الرابط » "..(redis:get(Monster..'lock_linkk'..msg.chat_id_) or 'false')
.."\n*📮¦* المغادره » "..(redis:get(Monster..'lock_leftgroup'..msg.chat_id_) or 'false')
.."\n*🗳¦* الحظر » "..(redis:get(Monster..'lock_KickBan'..msg.chat_id_) or 'false')
.."\n*🔍¦* الحمايه » "..(redis:get(Monster..'antiedit'..msg.chat_id_) or 'false')
.."\n*📋¦* التاك للكل » "..(redis:get(Monster..'lock_takkl'..msg.chat_id_) or 'false')
.."\n*📒¦* الايدي بالصوره » "..(redis:get(Monster..'idphoto'..msg.chat_id_) or 'false')
.."\n*🔐¦* التحقق » "..(redis:get(Monster.."lock_check"..msg.chat_id_) or 'false')
.."\n*🗑¦* التنظيف التلقائي » "..(redis:get(Monster.."lock_cleaner"..msg.chat_id_) or 'false')
.."\n*📂¦* ردود السورس » "..(redis:get(Monster.."lock_rdodSource"..msg.chat_id_) or 'false')
...
.."\n*➕¦* عدد التكرار » "..(redis:get(Monster..'num_msg_max'..msg.chat_id_) or 'false')
.."\n\n*💱¦*` اعدادات التقـييد :`\n"
.."\n*💢¦* التقييد بالتوجيه » "..(redis:get(Monster..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸¦* التقييد بالصور » "..(redis:get(Monster..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗¦* التقييد بالروابط » "..(redis:get(Monster..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉¦* التقييد بالمتحركه » "..(redis:get(Monster..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥¦* التقييد الفيديو » "..(redis:get(Monster..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
...
.."\n*🗂¦* الملفات » "..(redis:get(Monster..'mute_document'..msg.chat_id_) or 'false')
.."\n*🔅¦* الاشعارات » "..(redis:get(Monster..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n*🔒¦* الكيبورد » "..(redis:get(Monster..'mute_keyboard'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '{ مقفول }')
list_settings = list_settings:gsub('false', '{ مفتوح }')
return sendMsg(msg.chat_id_,msg.id_,'➖\n'..list_settings..'\n')
end
