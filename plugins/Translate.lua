...
local url , res = https.request('https://translate.yandex.net/api/v1/tr.json/translate?srv=android&uuid=6f4c351f-e58f-48d2-bda6-3cae1bddcbb4&id=e93642f1-1cd7-479e-9f93-08405027065b-9-0&lang='..Text:gsub('/','')..'&text='..data.content_.text_:gsub(" ",'+'))
